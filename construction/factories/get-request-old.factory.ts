...
// import { getFileNameWithoutExtensionFromOpenApiRoute, toKebabCase, Tools } from '../services/tools.service';
...
// 		this.featureServiceFile.addLineToMethodAlreadyExisting(this.method.name, returnLine);
// 		this.featureServiceFile.addImport(dtoName, `../dtos/${toKebabCase(dtoName)}.dto`);
// 	}
//
//
//
...
// 		geneseRequestService.addLineToMethodAlreadyExisting('init', `this.${this.method.name} = this.${Tools.unCapitalize(this.classNameService)}.${this.method.name};`);
